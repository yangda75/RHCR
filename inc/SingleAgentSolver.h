...
public:
  ...
  int num_of_conf;  // number of conflicts between this agent to all the other
                    // agents
  ...
  virtual Path run(const BasicGraph &G, const State &start,
                   ...
                   ReservationTable &RT) = 0;
  virtual string getName() const = 0;
  SingleAgentSolver()
      : suboptimal_bound(1), num_expanded(0), num_generated(0), min_f_val(0),
        num_of_conf(0) {}
