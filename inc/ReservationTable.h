...
public:
    ...
    void build(const vector<Path *> &paths, const list<tuple<int, int, int>> &initial_constraints,
...
private:
    ...
    void mergeIntervals(list<Interval> &intervals) const; // merge successive safe intervals with
